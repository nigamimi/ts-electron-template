...
const webpack_config_main_prod_1 = __importDefault(require("./config/webpack.config.main.prod"));
/*!*************************************************************************************************
                                            CONSTANTS
***************************************************************************************************/
...
const build = async (dotenvPath, appDir, pathsRelative, buildDirRelative) => {
    ...
    try {
        ...
        try {
            ...
            const config = webpack_config_main_prod_1.default(paths);
    ...
    const messages = (() => {
        ...
        if (err) {
            ...
            return formatWebpackMessages_1.default({
                //@ts-ignore
                warnings: (_b = (_a = statsJson.warnings) === null || _a === void 0 ? void 0 : _a.map((warning) => warning.message)) !== null && _b !== void 0 ? _b : [],
                //@ts-ignore
                errors: (_d = (_c = statsJson.errors) === null || _c === void 0 ? void 0 : _c.map((error) => error.message)) !== null && _d !== void 0 ? _d : [],
            });
        }
    })();
...
const printMessage = (paths, previousFileSizes, stats, warnings) => {
    if (warnings.length) {
    ...
    FileSizeReporter_1.printFileSizesAfterBuild(stats, previousFileSizes, paths.appBuild);
    console.log();
};
