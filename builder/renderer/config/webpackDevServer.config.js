...
function default_1(paths, proxy, allowedHost) {
    return {
        ...
        watchOptions: {
            ignored: ignoredFiles_1.default(paths.appSrc),
        },
        https: getHttpsConfig_1.default(paths),
        host,
        overlay: false,
        historyApiFallback: {
        ...
        before(app, server) {
            ...
            if (fs_1.default.existsSync(paths.proxySetup)) {
        ...
        after(app) {
            ...
            app.use(redirectServedPathMiddleware_1.default(paths.publicUrlOrPath));
            // This service worker file is effectively a 'no-op' that will reset any
            // previous service worker registered for the same host:port combination.
            // We do this in development to avoid hitting the production cache if
            // it used the same host and port.
            // https://github.com/facebook/create-react-app/issues/2272#issuecomment-302832432
            app.use(noopServiceWorkerMiddleware_1.default(paths.publicUrlOrPath));
        },
    };
}
