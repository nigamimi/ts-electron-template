...
import {
    ...
    prepareProxy,
    Urls,
    CreateCompilerOptionsTypescript as OldCreateCompilerOptionsTypescript,
} from "react-dev-utils/WebpackDevServerUtils";
const prepareUrls = require("react-dev-utils/WebpackDevServerUtils").prepareUrls as (
    protocol: string,
    host: string,
    port: number,
    pathname?: string
...
export interface CreateCompilerOptionsTypescript extends OldCreateCompilerOptionsTypescript {
    tscCompileOnError?: boolean;
}
const createCompiler = require("react-dev-utils/WebpackDevServerUtils").createCompiler as (
...
export const start = async (
    ...
    try {
        ...
        const serverConfig = createDevServerConfig(paths, proxyConfig, urls.lanUrlForConfig);
