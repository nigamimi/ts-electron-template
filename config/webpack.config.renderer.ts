...
import getClientEnvironment from "./renderer/env";
// "create-react-app@4.0.1" depends to "react-dev-utils@^11.0.0"
// but most recent "@types/react-dev-utils" is only 9.0.0. Alas!
//@ts-expect-error
...
const appPackageJson = require(paths.appPackageJson) as typeof packageJson;
...
export default function (webpackEnv: string): webpack.Configuration {
    ...
    return {
        mode: (isEnvProduction ? "production" : isEnvDevelopment && "development") as
            | "production"
            | "development"
            | undefined,
        ...
        optimization: {
            ...
            runtimeChunk: {
                name: (entrypoint: { name: string | number }) => `runtime-${entrypoint.name}`,
            },
        },
        resolve: {
